      ...
      <div class="w-full h-full bg-black/50">
        <div class="flex justify-center items-center w-full h-full relative text-white">
          <div class="flex flex-col justify-center items-center">
            ...
            <span class="text-sm text-center">Di sini tempat rental terpercaya dan terjamin keamanannya, silahkan klik dibawah ini untuk selengkapnya</span>
            <button class="px-10 py-4 bg-white rounded-lg mt-5 text-black font-semibold hover:scale-105 duration-300">Sewa sekarang</button>
          </div>
        </div>
      </div>
    </section>
